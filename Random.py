...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7907155504:AAE_KlRS9FM7jc5eEf0zaquVWQ-vzqTzmcQ'
ADMIN_USER_ID = 5047224084 # Replace with your admin user ID
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to a4x_Crypto DDOS world 🔥*\n\n"
